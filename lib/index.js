const { assoc, Async: Task, constant, curry, hasProp, hasPropPath, ifElse, isEmpty, Pair, pick, propOr, setPath, propPathOr, unless, when } = require('crocks')
...
const assertResponseHeaderNotExist = safeAssert(_assertResponseHeaderNotExist)
const assertResponseBodyPath = safeAssert(_assertResponseBodyPath)
const assertResponseBodyContains = safeAssert(_assertResponseBodyContains)
const assertResponseBodyWithSchema = safeAssert(_assertResponseBodyWithSchema)
